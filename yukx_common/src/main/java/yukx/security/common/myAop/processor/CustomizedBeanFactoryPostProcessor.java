...
/**
 * @ClassName CustomizedBeanFactoryPostProcessor
...
public class CustomizedBeanFactoryPostProcessor implements BeanFactoryPostProcessor {
            ...
            for (Method method : methods) {
                ...
                for (Annotation annotation : annotations) {
                    ...
                    if (AspectUtil.POINTCUT.equals(annotationName)) {
                        ...
                        if (StringUtils.isNotEmptys(value)) {
                            //获取切点指定包
            ...
            for (Method method : methods) {
                ...
                for (Annotation annotation : annotations) {
                    ...
                    if (AspectUtil.BEFORE.equals(annotationName) || AspectUtil.AFTER.equals(annotationName)
                        ...
                        try {
                            doScan(beanDefinitionClazz, method, annotation);
                        } catch (Exception e) {
     ...
     * @Exception :
     */
    private void doScan(Class<?> clazz, Method method, Annotation annotation) throws URISyntaxException {
        //保存代理信息
        ProxyBeanHolder proxyBeanHolder = new ProxyBeanHolder(clazz, method.getName(), annotation.annotationType().getName());
        ...
        //遍历包、找到包下的所有目标类
        if (StringUtils.isNotEmptys(packagePath)) {
